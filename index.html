   ...
   <section id="about">  
   	...
   	<div class="row about-content">
   		...
   		<div class="col-six tab-full">
   			...
   			<h3>Profile</h3>
                <p>A First Year student in Computer Science and Engineering (CSE) B.Tech. from KJ Somaiya College Of Engineering with excellent academic background and diverse skillset.                       Experienced in Web and Android Development.
                   I am well versed with HTML, Python, Kotlin, Java, C++ and basics of JavaScript & CSS.</p>
