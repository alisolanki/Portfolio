...
<head>
   ...
   ================================================== -->
   <meta charset="utf-8">
	<title>Ali Solanki | Portfolio Website | Full Stack Developer</title>
	<meta name="description" content="Ali Solanki is a Web developer, Android developer and is a B.Tech student at KJ Somaiya College Of Engineering">  
    ...
    <meta name="summary" content="This is Ali Solanki's Portfolio Website who is a Web developer and Android developer.">
    ...
    <meta name="url" content="https://www.alisolanki.gq">
    <meta name="identifier-URL" content="https://www.alisolanki.gq">
   ...
   <section id="intro">   
   	...
   	<div class="intro-content">
        ...
        <ul class="intro-social">
            ...
            <li><a href="https://play.google.com/store/apps/details?id=com.showworld.showworldfilmdirectory"><i class="fa fa-google-play"></i></a></li>
        </ul> <!-- /intro-social -->      	
   ...
   <section id="about">
   	...
   	<div class="row section-intro">
   		<div class="col-twelve">
            ...
            <div style="padding-bottom: 10rem; height: 400px;">
                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/ve31izeWZMI" frameborder="0" 
   			...
   			<div class="intro-info">
   				...
   				<p class="lead">"An <font color="#FF0077">Average</font> boy with not so <font color="#FF0077">Average</font> dreams."</p>
   			</div>   			
   	...
   	<div class="row about-content">
   		...
   		<div class="col-six tab-full">
   			...
   			<h3>Profile</h3>
                <p>A First Year student in Computer Science and Engineering (CSE) B.Tech. from KJ Somaiya College Of Engineering with excellent academic background and diverse skillset.                       Experienced in Web, Flutter and Android Development.
                   I am well versed with Flutter, HTML, Python, Kotlin, Java, C++ and basics of JavaScript & CSS.</p>

                <p>Currently working at <a href="https://showworldfilm.gq">Show World Film Directory</a></p>
   			...
   			<ul class="info-list">
   				...
   				<li>
   					...
   					<span><a href="#">https://alisolanki.gq</a></span>
   				</li>
                    <li>
                        <strong>Email:</strong>
   	...
   	<div class="row button-section">
   		<div class="col-twelve">
   			...
   			<a href="Ali_Solanki_CV.pdf" title="Download CV" class="button button-primary">Download CV</a>
   		</div>   		
   	</div>
   		...
   		<div class="col-twelve">
             ...
             <div class="bgrid folio-item">
                ...
                <div id="modal-06" class="popup-modal slider mfp-hide">	
			         ...
			         <div class="link-box">
			            <a href="https://play.google.com/store/apps/details?id=com.showworld.showworldfilmdirectory">Playstore App</a>
	...
	<section id="contact">
   	...
   	<div class="row contact-form">
   		...
   		<div class="col-twelve">
            ...
            <!-- form -->
            <form name="form" id="contactForm" method="POST" action="test.php">
      			<fieldset>
                    ...
                    <div class="form-field">
                        ...
                        <!-- <input type="submit" name="submit" value="sign in" onclick="test()"/> -->
